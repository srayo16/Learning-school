...
const AdmissionPrep = () => {
  return (
    <div className="bg-green-100 py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full lg:w-3/4 mx-auto">
        <div className="p-5 hover:drop-shadow-lg hover:scale-110 transition duration-300 cursor-pointer">
          <div className="flex bg-slate-100 lg:w-[500px] rounded-lg">
            <Image
              width={"200px"}
              height={"111px"}
              className="rounded-l-lg"
              src="https://cdn.10minuteschool.com/images/Admission/Thumbnails%20V-2/A%20unit.jpg"
              alt="A-unit"
            />
            <div className="flex items-center ml-5">
              <div>
                <h2 className="text-xl font-bold">University Science</h2>
                <div className="flex ">
                  <svg
                    width="100%"
                    height="100%"
      ...
      <div className="flex justify-center items-center mt-3">
        <button className="btn bg-[#27895d]">Explore All Program</button>
      </div>
    </div>
  );
};
